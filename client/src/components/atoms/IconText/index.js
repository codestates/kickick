...
export const iconList = [
  ...
  { icon: <FaBook />, label: "학습_자유", category: "게시판" },
  { icon: <FaAffiliatetheme />, label: "여가_자유", category: "게시판" },
  { icon: <FaShoppingBag />, label: "생활_자유", category: "게시판" },
  { icon: <FaGuitar />, label: "예술_자유", category: "게시판" },
  { icon: <FaMoneyBillAlt />, label: "경제_자유", category: "게시판" },
  { icon: <FaHelicopter />, label: "여행_자유", category: "게시판" },
